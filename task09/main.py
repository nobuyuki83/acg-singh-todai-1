...
class HelloWorld(mglw.WindowConfig):
    ...
    def render(self, time, frame_time):
        ...
        self.vtx2xyz_def[:]=numpy.ascontiguousarray(spsolve(self.matrix_laplace+self.matrix_fix,self.matrix_fix.dot(self.vtx2xyz_def)+self.matrix_laplace.dot(self.vtx2xyz_ini)))
        # self.vtx2xyz_def[:]=numpy.ascontiguousarray(spsolve(self.matrix_bilaplace+self.matrix_fix,self.matrix_fix.dot(self.vtx2xyz_def)+self.matrix_bilaplace.dot(self.vtx2xyz_ini)))
